...
namespace ECMS.Core.Interfaces
{
    public interface IValidURLRepository
    {
        ...
        ValidUrl GetByFriendlyUrl(int siteId_, string friendlyurl_, bool isPreview_);
        ValidUrl GetById(int siteId_, Guid urlId_, bool isPreview_);
        List<ValidUrl> GetAll(int siteId_, bool isPreview_);
